	...
	return (
		<Container style={{ backgroundColor: '#15202B', color: 'white' }} fluid>
			<Row className="columnContainer">
				<Col
          className="lefttabmobile d-none d-md-flex"
					style={{
						display: 'flex',
				...
				>
					<div className="list">
						...
						<div className="list_item">
							<div style={{ height: 'auto' }}>
								...
								>
									<path
										d="M26.3333 20.375C27.714 20.375 28.8333 19.3117 28.8333 18C28.8333 16.6883 27.714 15.625 26.3333 15.625C24.9526 15.625 23.8333 16.6883 23.8333 18C23.8333 19.3117 24.9526 20.375 26.3333 20.375Z"
										fill="white"
									/>
									<path
										d="M18 20.375C19.3807 20.375 20.5 19.3117 20.5 18C20.5 16.6883 19.3807 15.625 18 15.625C16.6193 15.625 15.5 16.6883 15.5 18C15.5 19.3117 16.6193 20.375 18 20.375Z"
										fill="white"
									/>
									<path
										d="M9.66666 20.375C11.0474 20.375 12.1667 19.3117 12.1667 18C12.1667 16.6883 11.0474 15.625 9.66666 15.625C8.28594 15.625 7.16666 16.6883 7.16666 18C7.16666 19.3117 8.28594 20.375 9.66666 20.375Z"
										fill="white"
									/>
									<path
										d="M18 35.0208C8.12 35.0208 0.0833282 27.386 0.0833282 18C0.0833282 8.614 8.12 0.979168 18 0.979168C27.88 0.979168 35.9167 8.614 35.9167 18C35.9167 27.386 27.88 35.0208 18 35.0208ZM18 3.35417C9.5 3.35417 2.58333 9.925 2.58333 18C2.58333 26.075 9.5 32.6458 18 32.6458C26.5 32.6458 33.4167 26.075 33.4167 18C33.4167 9.925 26.5 3.35417 18 3.35417Z"
										fill="white"
									/>
								</svg>
							</div>
							<div className="list_text">More</div>
						</div>
					...
					<div className="profile">
						<div className="avi">avi</div>
						<div className="profile_name">profile name</div>
						<div className="btn-x">btn</div>
					</div>
				</Col>
				<Col className="columns middle midtab">
					...
					<div className="middle_body">
						<div className="whats_happening">
							<div className="half upper">
								<img
									src={
										'https://pbs.twimg.com/profile_images/1258864613585813505/EkLbcHbk_400x400.jpg'
									}
									className="wh_avi"
								/>

								<div className="wh_text_input d-none d-md-flex">
									<div>
										<div
											...
											contentEditable
											className="whats_happening_text_area"
											name=""
											id=""
										/>
									</div>
									...
									<div className="icon_with_tweet">
										<div className="icon_group">
											...
											>
												<path
													d="M39.5 3.41667H8.5C6.02 3.41667 4 5.14208 4 7.26042V33.7396C4 35.8579 6.02 37.5833 8.5 37.5833H39.5C41.98 37.5833 44 35.8579 44 33.7396V7.26042C44 5.14208 41.98 3.41667 39.5 3.41667ZM8.5 5.97917H39.5C40.326 5.97917 41 6.55487 41 7.26042V23.7902L33.284 17.1995C33.004 16.9603 32.624 16.8237 32.224 16.8237H32.218C31.818 16.8237 31.432 16.9603 31.154 17.2063L22.52 24.6957L18.894 21.6104C18.614 21.3712 18.234 21.2346 17.834 21.2346C17.448 21.1833 17.044 21.3712 16.764 21.6224L7 30.1384V7.26042C7 6.55487 7.674 5.97917 8.5 5.97917ZM7.012 33.7908L17.848 24.3369L30.412 35.0208H8.5C7.696 35.0208 7.046 34.4708 7.012 33.7908ZM39.5 35.0208H34.66L24.646 26.5014L32.23 19.9243L41 27.4136V33.7396C41 34.4451 40.326 35.0208 39.5 35.0208Z"
													fill="rgb(29, 161, 242)"
												/>
												<path
													d="M17.736 16.8288C19.4393 16.8288 20.82 15.6494 20.82 14.1945C20.82 12.7397 19.4393 11.5603 17.736 11.5603C16.0328 11.5603 14.652 12.7397 14.652 14.1945C14.652 15.6494 16.0328 16.8288 17.736 16.8288Z"
													fill="rgb(29, 161, 242)"
												/>
											</svg>
											...
											>
												<path
													d="M38 23.1875V19.4333H29.2V33.5667H32.6V29.15H36.6V25.3958H32.6V23.1875H38V23.1875ZM23.4 19.4333H26.8V33.5667H23.4V19.4333ZM16.2 22.9667C17 22.9667 18 23.4083 18.6 24.0708L21 21.8625C19.8 20.3167 18 19.4333 16.2 19.4333C12.6 19.4333 9.8 22.525 9.8 26.5C9.8 30.475 12.6 33.5667 16.2 33.5667C18.2 33.5667 19.8 32.6833 21 31.1375V25.6167H15.4V28.2667H17.8V29.5917C17.4 29.8125 16.8 30.0333 16.2 30.0333C14.4 30.0333 13 28.4875 13 26.5C13 24.7333 14.4 22.9667 16.2 22.9667V22.9667Z"
													fill="rgb(29, 161, 242)"
												/>
												<path
													d="M41 4.46083H7C4.52 4.46083 2.5 6.68463 2.5 9.42296V43.6676C2.5 46.4015 4.52 48.6275 7 48.6275H41C43.48 48.6275 45.5 46.4015 45.5 43.6676V9.42296C45.5 6.68463 43.48 4.46083 41 4.46083V4.46083ZM42.5 43.6676C42.5 44.573 41.828 45.315 41 45.315H7C6.172 45.315 5.5 44.573 5.5 43.6676V9.42296C5.5 8.51313 6.172 7.77333 7 7.77333H41C41.828 7.77333 42.5 8.51313 42.5 9.42296V43.6676Z"
													fill="rgb(29, 161, 242)"
												/>
											</svg>
											<svg
											...
											>
												<path
													d="M25.5 43.6042C12.903 43.6042 2.65625 34.362 2.65625 23C2.65625 11.638 12.903 2.39584 25.5 2.39584C38.097 2.39584 48.3438 11.638 48.3438 23C48.3438 34.362 38.097 43.6042 25.5 43.6042ZM25.5 5.27084C14.6625 5.27084 5.84375 13.225 5.84375 23C5.84375 32.775 14.6625 40.7292 25.5 40.7292C36.3375 40.7292 45.1562 32.775 45.1562 23C45.1562 13.225 36.3375 5.27084 25.5 5.27084Z"
													fill="rgb(29, 161, 242)"
												/>
												<path
													d="M25.5 32.8038C21.4795 32.8038 17.7799 30.9829 15.606 27.9278C15.13 27.2608 15.3446 26.3753 16.0863 25.944C16.8258 25.5109 17.8118 25.7064 18.2878 26.3772C19.8751 28.6044 22.5718 29.9326 25.5021 29.9326C28.4325 29.9326 31.1291 28.6044 32.7186 26.3791C33.1946 25.7083 34.1806 25.5166 34.9201 25.9479C35.6639 26.3772 35.8764 27.2665 35.4004 27.9335C33.2223 30.9887 29.5226 32.8114 25.5021 32.8114L25.5 32.8038Z"
													fill="rgb(29, 161, 242)"
												/>
												<path
													d="M31.3182 20.9607C33.0528 20.9607 34.459 19.6924 34.459 18.1278C34.459 16.5633 33.0528 15.295 31.3182 15.295C29.5837 15.295 28.1775 16.5633 28.1775 18.1278C28.1775 19.6924 29.5837 20.9607 31.3182 20.9607Z"
													fill="rgb(29, 161, 242)"
												/>
												<path
													d="M19.6818 20.9607C21.4163 20.9607 22.8225 19.6924 22.8225 18.1278C22.8225 16.5633 21.4163 15.295 19.6818 15.295C17.9472 15.295 16.541 16.5633 16.541 18.1278C16.541 19.6924 17.9472 20.9607 19.6818 20.9607Z"
													fill="rgb(29, 161, 242)"
												/>
											</svg>
											<svg
											...
											>
												<g clip-path="url(#clip0)">
													<path
														d="M-86.8542 37.5C-87.0833 37.2917 -87.0833 37.2917 -87.0833 37.0833C-86.8542 37.0833 -86.8542 37.2917 -86.8542 37.5ZM41.25 4.58335H38.2708V3.95835C38.2708 3.12502 37.5833 2.29169 36.4375 2.29169C35.5208 2.29169 34.6042 2.91669 34.6042 3.95835V4.58335H17.6458V3.95835C17.6458 3.12502 16.9583 2.29169 15.8125 2.29169C14.8958 2.29169 13.9792 2.91669 13.9792 3.95835V4.58335H11C7.79166 4.58335 5.27082 6.87502 5.27082 9.79169V37.0833C5.27082 40 7.79166 42.2917 11 42.2917H17.6458C18.5625 42.2917 19.4792 41.6667 19.4792 40.625C19.4792 39.7917 18.7917 38.9584 17.6458 38.9584H11C9.62499 38.9584 8.70832 37.9167 8.70832 36.875V16.4584C8.70832 15.8334 9.62499 15 11 15H41.25C42.625 15 43.5417 15.8334 43.5417 16.4584V20.2084C43.5417 21.0417 44.2292 21.875 45.375 21.875C46.2917 21.875 47.2083 21.25 47.2083 20.2084V9.79169C46.9792 6.87502 44.4583 4.58335 41.25 4.58335V4.58335ZM43.5417 12.2917C42.8542 12.0834 41.9375 11.875 41.25 11.875H11C10.0833 11.875 9.39582 12.0834 8.70832 12.2917V9.79169C8.70832 8.54169 9.85416 7.70835 11 7.70835H13.9792V8.75002C13.9792 9.58335 14.6667 10.4167 15.8125 10.4167C16.7292 10.4167 17.6458 9.79169 17.6458 8.75002V7.70835H34.8333V8.75002C34.8333 9.58335 35.5208 10.4167 36.6667 10.4167C37.5833 10.4167 38.5 9.79169 38.5 8.75002V7.70835H41.25C42.625 7.70835 43.5417 8.75002 43.5417 9.79169V12.2917Z"
														fill="rgb(29, 161, 242)"
													/>
													<path
														d="M35.5208 21.6667C27.7292 21.6667 21.3125 27.5 21.3125 34.5834C21.3125 41.6667 27.7292 47.5 35.5208 47.5C43.3125 47.5 49.7292 41.6667 49.7292 34.5834C49.7292 27.5 43.3125 21.6667 35.5208 21.6667V21.6667ZM35.5208 44.5834C29.5625 44.5834 24.75 40.2084 24.75 34.7917C24.75 29.375 29.5625 25 35.5208 25C41.4792 25 46.2917 29.375 46.2917 34.7917C46.2917 40 41.4792 44.5834 35.5208 44.5834Z"
														fill="rgb(29, 161, 242)"
													/>
													<path
														d="M43.3125 38.9584C43.0833 39.375 42.3958 39.7917 41.9375 39.7917C41.7083 39.7917 41.25 39.7917 41.0208 39.5834L33.9167 35.4167V29.1667C33.9167 28.3334 34.6042 27.5 35.75 27.5C36.6667 27.5 37.5833 28.125 37.5833 29.1667V33.75L43.0833 36.875C43.5417 37.2917 43.7708 38.125 43.3125 38.9584V38.9584Z"
														fill="rgb(29, 161, 242)"
													/>
												</g>
												<defs>
          ...
          Tweets
				...
				<Col className="right_side righttabmobile d-none d-md-flex">
					...
					<div className="minitab">
						...
						<div className="tab">
							...
							<div className="tab_right">follow</div>
						</div>
					</div>

					<div className="minitab_follow">
						<div className="topics_to_follow">
							<div className="topics">Topics To follow</div>
							<div>
								<AiOutlineSetting
									color={'rgb(29, 161, 242)'}
									style={{ marginRight: '10px' }}
						...
						<div className="tab">
							<div className="tab_lef">
								<div>ligue1.trending</div>
								<div>lille</div>

								<div>20.8k tweets</div>
							</div>
							<div className="tab_right">follow</div>
						</div>
						<div className="tab">
